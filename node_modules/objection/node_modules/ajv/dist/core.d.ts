export { Format, FormatDefinition, AsyncFormatDefinition, KeywordDefinition, KeywordErrorDefinition, CodeKeywordDefinition, MacroKeywordDefinition, FuncKeywordDefinition, Vocabulary, Schema, SchemaObject, AnySchemaObject, AsyncSchema, AnySchema, ValidateFunction, AsyncValidateFunction, AnyValidateFunction, ErrorObject, ErrorNoParams, } from "objection/node_modules/ajv/dist/types";
export { SchemaCxt, SchemaObjCxt } from "objection/node_modules/ajv/dist/compile";
export interface Plugin<Opts> {
    (ajv: Ajv, options?: Opts): Ajv;
    [prop: string]: any;
}
export { KeywordCxt } from "objection/node_modules/ajv/dist/compile/validate";
export { DefinedError } from "objection/node_modules/ajv/dist/vocabularies/errors";
export { JSONType } from "objection/node_modules/ajv/dist/compile/rules";
export { JSONSchemaType } from "objection/node_modules/ajv/dist/types/json-schema";
export { JTDSchemaType, SomeJTDSchemaType, JTDDataType } from "objection/node_modules/ajv/dist/types/jtd-schema";
export { _, str, stringify, nil, Name, Code, CodeGen, CodeGenOptions } from "objection/node_modules/ajv/dist/compile/codegen";
import type { Schema, AnySchema, AnySchemaObject, SchemaObject, AsyncSchema, Vocabulary, KeywordDefinition, AddedKeywordDefinition, AnyValidateFunction, ValidateFunction, AsyncValidateFunction, ErrorObject, Format, AddedFormat, RegExpEngine, UriResolver } from "objection/node_modules/ajv/dist/types";
import type { JSONSchemaType } from "objection/node_modules/ajv/dist/types/json-schema";
import type { JTDSchemaType, SomeJTDSchemaType, JTDDataType } from "objection/node_modules/ajv/dist/types/jtd-schema";
import ValidationError from "objection/node_modules/ajv/dist/runtime/validation_error";
import MissingRefError from "objection/node_modules/ajv/dist/compile/ref_error";
import { ValidationRules } from "objection/node_modules/ajv/dist/compile/rules";
import { SchemaEnv } from "objection/node_modules/ajv/dist/compile";
import { Code, ValueScope } from "objection/node_modules/ajv/dist/compile/codegen";
