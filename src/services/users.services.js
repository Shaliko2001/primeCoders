...
export default class UsersServices {
  ...
  static async addStudent(info) {
    return await UsersModel.addStudent(info);
  }
  
  static async getAllStudents() {
    return await UsersModel.getAllStudents();
  }
  static async getStudentsByCourseName(courseName) {
    return await UsersModel.getStudentsByCourseName(courseName);
  }
